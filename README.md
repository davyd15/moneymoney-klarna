...
| Version | Changes |
|---------|---------|
| 5.23 | Dialog now shows GitHub repo URL (shorter, README links to setup guide) |
| 5.22 | Fix: remove `os.execute` call (sandboxed in MoneyMoney) |
| 5.21 | Reverted — see 5.22 |
